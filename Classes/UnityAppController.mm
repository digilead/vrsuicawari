...
{
    int accel = [[message objectForKey:@"Accel"] intValue];
    if( accel > 20 ) {
        UnitySendMessage([@"bou" UTF8String], [@"Attack" UTF8String], [@"" UTF8String]);
    }
    else {
        UnitySendMessage([@"bou" UTF8String], [@"Walk" UTF8String], [@"" UTF8String]);
    }
