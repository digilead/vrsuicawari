...
IL_004c:
	...
	{
		float L_7 = Time_get_unscaledDeltaTime_m4116105713(NULL /*static, unused*/, /*hidden argument*/NULL);
		G_B8_0 = L_7;
		G_B8_1 = G_B6_0;
...
IL_0078:
	{
		...
		float L_12 = Mathf_Clamp01_m1808233504(NULL /*static, unused*/, (float)((float)((float)L_9/(float)L_11)), /*hidden argument*/NULL);
...
extern "C"  void TweenRunner_1_StartTween_m3060079017_gshared (TweenRunner_1_t1434350349 * __this, ColorTween_t2894377818  ___info0, const MethodInfo* method)
{
	...
	}
	{
		...
		bool L_1 = Object_op_Equality_m785621534(NULL /*static, unused*/, (Object_t3878351788 *)L_0, (Object_t3878351788 *)NULL, /*hidden argument*/NULL);
		if (!L_1)
		{
			goto IL_001c;
		}
...
IL_003f:
	{
		...
		GameObject_t4012695102 * L_6 = Component_get_gameObject_m113347205((Component_t2126946602 *)L_5, /*hidden argument*/NULL);
