...
struct  MovementTransferOnJump_t501960999 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MovementTransferOnJump_t501960999, ___value___1)); }
