...
struct  SurfaceMaterial_t459108564 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SurfaceMaterial_t459108564, ___value___1)); }
